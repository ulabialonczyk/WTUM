...
coffee_train <- read.table('/Users/Ula/Desktop/wtum/OliveOil_TRAIN.txt')

coffee_test <- read.table('/Users/Ula/Desktop/wtum/OliveOil_TEST.txt')

macierz_przelomow_coffee <- read.csv('/Users/Ula/Desktop/wtum/macierz_przelomow_olive.csv')
...
# ---------------------------------- METODA 1 ---------------------------------------- #
przelomy = read.csv('/Users/Ula/Desktop/wtum/przelomy_olive50.csv')
przelomy = c(przelomy$x)
...
predykcje_1kv = getLabels(knn_coffee[, -c(8, 9, 18, 20, 21, 32, 33, 35)])
...
predykcje_3kv = getLabels(knn_coffee[, -c(8, 9, 18, 20, 21, 32, 33, 35)])
...
predykcje_5kv = getLabels(knn_coffee[, -c(8, 9, 18, 20, 21, 32, 33, 35)])
...
predykcje_7kv = getLabels(knn_coffee[, -c(8, 9, 18, 20, 21, 32, 33, 35)])
...
rows=apply(macierz_przelomow_coffee, 1, function(x){
  print(all(is.na(x)))
})
idx = which(rows==TRUE) # wiersze macierzy z samymi NA

macierz_klasyfikatorów1 = apply(macierz_przelomow_coffee[-idx, ],1, function(x){
...
m2_acc_k1 = sum(labels1 == coffee_test_labels)/30

acc_poszczegolnych_k1=apply(macierz_klasyfikatorów1==coffee_test_labels, 2, sum)/30 # 0.9067 najlepiej

# k = 3

macierz_klasyfikatorów3 = apply(macierz_przelomow_coffee[-idx, ],1, function(x){
...
m2_acc_k3= sum(labels3 == coffee_test_labels)/30


acc_poszczegolnych_k3=apply(macierz_klasyfikatorów3==coffee_test_labels, 2, sum)/30 # najlepszy 0.88


#k = 5
macierz_klasyfikatorów5 = apply(macierz_przelomow_coffee[-idx, ],1, function(x){
...
m2_acc_k5 = sum(labels5 == coffee_test_labels)/30

acc_poszczegolnych_k5=apply(macierz_klasyfikatorów5==coffee_test_labels, 2, sum)/30


# k = 7
macierz_klasyfikatorów7 = apply(macierz_przelomow_coffee[-idx, ],1, function(x){
...
m2_acc_k7 = sum(labels7 == coffee_test_labels)/30

acc_poszczegolnych_k7=apply(macierz_klasyfikatorów7==coffee_test_labels, 2, sum)/30

# k = 9
macierz_klasyfikatorów9 = apply(macierz_przelomow_coffee[-idx, ],1, function(x){
...
m2_acc_k9 = sum(labels9 == coffee_test_labels)/30

acc_poszczegolnych_k9=apply(macierz_klasyfikatorów9==coffee_test_labels, 2, sum)/30
...
write.csv(wyniki_poszczegolnych, '/Users/Ula/Desktop/wtum/wyniki_poszczegolnych_olive.csv')
...
#14, 32, 40
komitet_najlepszych = getLabels(cbind(macierz_klasyfikatorów1[, c(7, 10)],  macierz_klasyfikatorów3[, 10]))
m2_acc_komitet_najlepszych = sum(komitet_najlepszych==coffee_test_labels)/30


table(komitet_najlepszych,coffee_test_labels) #0.9

# komitet z 1, 3, 5
etykiety_komitet = getLabels(cbind(labels1, labels3))
m2_acc_komitet = sum(etykiety_komitet==coffee_test_labels)/30
...
m2_acc_k1s = sum(labels1s == coffee_test_labels)/30

acc_poszczegolnych_k1s=apply(macierz_klasyfikatorów1s==coffee_test_labels, 2, sum)/30 # 0.96
...
m2_acc_k3s= sum(labels3s == coffee_test_labels)/30

acc_poszczegolnych_k3s=apply(macierz_klasyfikatorów3s ==coffee_test_labels, 2, sum)/30
...
m2_acc_k5s = sum(labels5s == coffee_test_labels)/30

acc_poszczegolnych_k5s=apply(macierz_klasyfikatorów5s==coffee_test_labels, 2, sum)/30
...
m2_acc_k7s = sum(labels7s == coffee_test_labels)/30

acc_poszczegolnych_k7s=apply(macierz_klasyfikatorów7s==coffee_test_labels, 2, sum)/30
...
m2_acc_k9s = sum(labels9s== coffee_test_labels)/30

acc_poszczegolnych_k9s=apply(macierz_klasyfikatorów9s==coffee_test_labels, 2, sum)/30
...
write.csv(wyniki_poszczegolnych_s, '/Users/Ula/Desktop/wtum/wyniki_poszczegolnych_olive_scalone.csv')
...
komitet_najlepszych = getLabels(cbind(macierz_klasyfikatorów1s[, c(10, 13)]))

m2_acc_komitet_najlepszych_s = sum(komitet_najlepszych==coffee_test_labels)/30

table(komitet_najlepszych, coffee_test_labels)
# komitet z 1, 3, 5
etykiety_komitet = getLabels(cbind(labels3s, labels1s))
m2_acc_komitet = sum(etykiety_komitet==coffee_test_labels)/30
