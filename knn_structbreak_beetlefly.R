...
coffee_train <- read.table('/Users/Ula/Desktop/wtum/BeetleFly_TRAIN.txt')

coffee_test <- read.table('/Users/Ula/Desktop/wtum/BeetleFly_TEST.txt')

macierz_przelomow_coffee <- read.csv('/Users/Ula/Desktop/wtum/macierz_przelomow_beetlefly.csv')
...
#14, 32, 40
komitet_najlepszych = getLabels(cbind(macierz_klasyfikatorów1[, c(6, 11)],  macierz_klasyfikatorów3[, 4]))
