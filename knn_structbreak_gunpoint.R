...
coffee_train <- read.table('/Users/Ula/Desktop/wtum/GunPoint_TRAIN.txt')


coffee_test <- read.table('/Users/Ula/Desktop/wtum/GunPoint_TEST.txt')

macierz_przelomow_coffee <- read.csv('/Users/Ula/Desktop/wtum/macierz_przelomow_gun.csv')
...
m2_acc_k1s = sum(labels1s == coffee_test_labels)/150

acc_poszczegolnych_k1s=apply(macierz_klasyfikatorów1s==coffee_test_labels, 2, sum)/150 # 0.96
...
m2_acc_k3s= sum(labels3s == coffee_test_labels)/150

acc_poszczegolnych_k3s=apply(macierz_klasyfikatorów3s ==coffee_test_labels, 2, sum)/150
...
m2_acc_k5s = sum(labels5s == coffee_test_labels)/150

acc_poszczegolnych_k5s=apply(macierz_klasyfikatorów5s==coffee_test_labels, 2, sum)/150
...
m2_acc_k7s = sum(labels7s == coffee_test_labels)/150

acc_poszczegolnych_k7s=apply(macierz_klasyfikatorów7s==coffee_test_labels, 2, sum)/150
...
m2_acc_k9s = sum(labels9s== coffee_test_labels)/150

acc_poszczegolnych_k9s=apply(macierz_klasyfikatorów9s==coffee_test_labels, 2, sum)/150
